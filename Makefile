...
build-all: build/news-scrap

build/news-scrap: FORCE
	go build $(GO_BUILDFLAGS) -ldflags '-s -w $(GO_LDFLAGS)' -o build/news-scrap ./cmd/news/
...
install: FORCE build/news-scrap
	install -d -m 0755 "$(DESTDIR)$(PREFIX)/bin"
	install -m 0755 build/news-scrap "$(DESTDIR)$(PREFIX)/bin/news-scrap"
...
help: FORCE
	...
	@printf "  \e[36mbuild/news-scrap\e[0m      Build news-scrap.\n"
